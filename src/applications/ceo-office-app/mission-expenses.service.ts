...
import { MissionExpense, MissionExpenseDocument } from './entities/mission-expense.entity';
...
export class MissionExpensesService {
    ...
    async create(createMissionExpenseDto: CreateMissionExpenseDto): Promise<MissionExpense> {
        const createdMissionExpense = new this.missionExpenseModel(createMissionExpenseDto);
    ...
    async update(id: string, updateMissionExpenseDto: UpdateMissionExpenseDto): Promise<MissionExpense> {
    ...
    async remove(id: string): Promise<MissionExpense> {
        const deletedMissionExpense = await this.missionExpenseModel.findByIdAndDelete(id).exec();
